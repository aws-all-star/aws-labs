...
![이미지 2](https://github.com/user-attachments/assets/823b26fe-263d-4c38-bb38-891f20c2bad7)<br/>
MongoDB는 애플리케이션 데이터에 대한 지속성을 제공합니다. MongoDB는 확장성과 개발자 민첩성을 염두에 두고 설계된 오픈 소스 문서 데이터베이스입니다. MongoDB는 빠르고 확장 가능한 키-값 저장소와 풍부한 기능을 갖춘 관계형 데이터베이스 사이의 격차를 해소합니다. MongoDB는 관계형 데이터베이스처럼 행과 열에 데이터를 저장하는 대신 동적 스키마로 JSON 문서를 컬렉션에 저장합니다.
MongoDB의 문서 데이터 모델을 사용하면 정교한 검증 규칙, 유연한 데이터 액세스 및 풍부한 인덱싱 기능을 포기하지 않고 모든 구조의 데이터를 쉽게 저장하고 결합할 수 있습니다. 가동 중지 시간 없이 스키마를 동적으로 수정할 수 있습니다. 이는 빠르게 진화하는 애플리케이션에 필수적입니다.
