...
|출시 목적|AWS 환경에 최적화 목적으로 개발|RHEL과 완벽한 1:1 바이너리 호환 (CentOS 대체)|엔터프라이즈급 상용 배포판|
...
## 테스트 결과
- 동일한 Public 서브넷과 VPC에서, ping 명령을 통해 서로 간 통신을 확인할 수 없어야 합니다.
- 2개 인스턴스 모두 사용자 클라이언트 환경에서 SSH 원격으로만 접속할 수 있지만 보안 요건 가이드에 맞춰 2121포트로 접근할 수 있어야 합니다.
<br/><br/>
